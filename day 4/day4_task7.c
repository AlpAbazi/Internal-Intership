...
void updateRecordById(StudentRecord records[], int count) {
    ...
    if (!readInteger("Enter student ID to update progress: ", &id)) {
        printf("Invalid input. Please enter a number.\n");
        return;
    }
...
void editRecord(StudentRecord *record) {
    ...
    if (!readInteger("Choose edit option: ", &choice)) {
        printf("Invalid input. Please enter a number.\n");
        return;
    }
    ...
    switch (choice) {
        case 1:
            clearInputBuffer();
            readLine("Enter new name: ", newName, sizeof(newName));
            if (strlen(newName) == 0) {
...
void editRecordById(StudentRecord records[], int count) {
    ...
    if (!readInteger("Enter student ID to edit: ", &id)) {
        printf("Invalid input. Please enter a number.\n");
        return;
    }
...
void deleteRecordById(StudentRecord records[], int *count) {
    ...
    if (!readInteger("Enter student ID to delete: ", &id)) {
        printf("Invalid input. Please enter a number.\n");
        return;
    }
