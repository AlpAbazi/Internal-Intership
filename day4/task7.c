...
void editStudent(struct Student students[], int count) {
    ...
    printf("Shkruaj ID te regjistrimit qe don me ndryshu: ");
    if (scanf("%d", &id) != 1) {
        printf("Input gabim.\n");
        while (getchar() != '\n');
        return;
    ...
    for (i = 0; i < count; i++) {
        if (students[i].id == id) {
            ...
            printf("\nCfare don me ndryshu?\n");
            printf("1. Emrin\n");
            printf("2. Progresin\n");
            printf("3. Statusin\n");
            printf("4. Emrin dhe Progresin\n");
            printf("5. Progresin dhe Statusin\n");
            printf("Zgjedh: ");
            ...
            switch (fieldChoice) {
                ...
                case 2:
                    ...
                    printf("Progresi u ndryshua me sukses.\n");
                    break;

                case 3:
                    printf("Zgjedh statusin e ri:\n");
                    printf("1. Not Started\n");
                    printf("2. In Progress\n");
                    printf("3. Completed\n");
                    printf("Zgjedh: ");
                    ...
                    printf("Statusi u ndryshua me sukses.\n");
                    break;
                ...
                case 5:
                    ...
                    printf("Progresi dhe statusi u ndryshuan me sukses.\n");
                    break;
...
void deleteStudent(struct Student students[], int *count) {
    ...
    printf("Shkruaj ID te regjistrimit qe don me fshi: ");
    if (scanf("%d", &id) != 1) {
        printf("Input gabim.\n");
        while (getchar() != '\n');
        return;
